...
export class RecipeUseCases {
    ...
    public getRecipeCards(searchTerm: string, categoryFilters: FilterItem[]): RecipeCard[] {
        ...
        return this.repository
            ...
            .map(recipe => mapRecipeToRecipeCard(recipe, ingredientSearchIsActive ? searchTerm : undefined));
    }
