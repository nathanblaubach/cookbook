...
export function mapRecipeToRecipeCard(recipe: Recipe, searchTerm?: string): RecipeCard {
    return {
        recipeId: recipe.id,
        recipeLink: `/recipes/${recipe.id}`,
        recipeName: recipe.name,
        relevantIngredients: getIngredientsContainingSearchTerm(recipe.ingredients, searchTerm)
    };
}
